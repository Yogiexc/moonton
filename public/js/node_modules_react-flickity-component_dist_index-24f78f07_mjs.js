"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_react-flickity-component_dist_index-24f78f07_mjs"],{

/***/ "./node_modules/react-flickity-component/dist/index-24f78f07.mjs":
/*!***********************************************************************!*\
  !*** ./node_modules/react-flickity-component/dist/index-24f78f07.mjs ***!
  \***********************************************************************/
...
/* harmony export */ });
/* harmony import */ var _index_48195875_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-48195875.mjs */ "./node_modules/react-flickity-component/dist/index-48195875.mjs");
...
var X = { exports: {} }, A = { exports: {} }, L = { exports: {} };
var $;
function ut() {
  return $ || ($ = 1, function(m) {
    (function(a, h) {
      ...
      function h(d) {
        var S = parseFloat(d), g = d.indexOf("%") == -1 && !isNaN(S);
        return g && S;
      }
      function f() {
      }
      ...
      function v(d) {
        if (c(), typeof d == "string" && (d = document.querySelector(d)), !(!d || typeof d != "object" || !d.nodeType)) {
          ...
          for (var p = g.isBorderBox = S.boxSizing == "border-box", D = 0; D < n; D++) {
            var i = r[D], u = S[i], y = parseFloat(u);
            g[i] = isNaN(y) ? 0 : y;
          }
          var x = g.paddingLeft + g.paddingRight, b = g.paddingTop + g.paddingBottom, E = g.marginLeft + g.marginRight, C = g.marginTop + g.marginBottom, P = g.borderLeftWidth + g.borderRightWidth, V = g.borderTopWidth + g.borderBottomWidth, j = p && s, Y = h(S.width);
          Y !== !1 && (g.width = Y + (j ? 0 : x + P));
          var Q = h(S.height);
          return Q !== !1 && (g.height = Q + (j ? 0 : b + V)), g.innerWidth = g.width - (x + P), g.innerHeight = g.height - (b + V), g.outerWidth = g.width + E, g.outerHeight = g.height + C, g;
        }
      }
      return v;
    });
  ...
  return J || (J = 1, function(m) {
    (function(a, h) {
      ...
      var h = function() {
        ...
        if (f.matches)
          return "matches";
        if (f.matchesSelector)
          return "matchesSelector";
        for (var l = ["webkit", "moz", "ms", "o"], r = 0; r < l.length; r++) {
          var n = l[r], o = n + "MatchesSelector";
          if (f[o])
            return o;
        }
      }();
  ...
  return Z || (Z = 1, function(m) {
    (function(a, h) {
      ...
      l.makeArray = function(o) {
        ...
        return o.forEach(function(s) {
          if (s instanceof HTMLElement) {
            ...
            f(s, t) && e.push(s);
            for (var c = s.querySelectorAll(t), v = 0; v < c.length; v++)
              e.push(c[v]);
          }
        }), e;
      }, l.debounceMethod = function(o, t, e) {
        e = e || 100;
        var s = o.prototype[t], c = t + "Timeout";
        o.prototype[t] = function() {
          var v = this[c];
          clearTimeout(v);
          var d = arguments, S = this;
      ...
      return l.htmlInit = function(o, t) {
        l.docReady(function() {
          var e = l.toDashed(t), s = "data-" + e, c = document.querySelectorAll("[" + s + "]"), v = document.querySelectorAll(".js-" + e), d = l.makeArray(c).concat(l.makeArray(v)), S = s + "-options", g = h.jQuery;
          d.forEach(function(p) {
            var D = p.getAttribute(s) || p.getAttribute(S), i;
            try {
              i = D && JSON.parse(D);
            } catch (y) {
  ...
  return K || (K = 1, function(m) {
    (function(a, h) {
      m.exports ? m.exports = h(
        a,
        ut()
      ) : (a.Flickity = a.Flickity || {}, a.Flickity.Cell = h(
        a,
        a.getSize
      ));
    })(window, function(h, f) {
      ...
      return r.create = function() {
        ...
        var o = this.parent.originSide === "left" ? 1 : -1, t = this.parent.options.percentPosition ? n * o * (this.parent.size.innerWidth / this.size.width) : n * o;
  ...
  return tt || (tt = 1, function(m) {
    (function(a, h) {
      ...
      return f.addCell = function(l) {
        ...
        var l = this.isOriginLeft ? "marginRight" : "marginLeft", r = this.getLastCell(), n = r ? r.size[l] : 0, o = this.outerWidth - (this.firstMargin + n);
  ...
  return et || (et = 1, function(m) {
    (function(a, h) {
      m.exports ? m.exports = h(
        a,
        z()
      ) : (a.Flickity = a.Flickity || {}, a.Flickity.animatePrototype = h(
        a,
        a.fizzyUIUtils
      ));
    })(window, function(h, f) {
      ...
      return l.startAnimation = function() {
        ...
        var r = this.slides[0];
        if (!!r) {
          var n = -this.x - r.target, o = n / this.slidesWidth;
          this.dispatchEvent("scroll", null, [o, n]);
        }
      }, l.positionSliderAtSelected = function() {
        !this.cells.length || (this.x = -this.selectedSlide.target, this.velocity = 0, this.positionSlider());
      }, l.getPositionValue = function(r) {
        return this.options.percentPosition ? Math.round(r / this.size.innerWidth * 1e4) * 0.01 + "%" : Math.round(r) + "px";
      }, l.settle = function(r) {
  ...
  return it || (it = 1, function(m) {
    (function(a, h) {
      if (m.exports)
        m.exports = h(
          a,
          (0,_index_48195875_mjs__WEBPACK_IMPORTED_MODULE_0__.r)(),
          ut(),
          z(),
          pt(),
          gt(),
      ...
      var e = h.jQuery, s = h.getComputedStyle, c = h.console;
      function v(i, u) {
        for (i = r.makeArray(i); i.length; )
          u.appendChild(i.shift());
      }
      var d = 0, S = {};
      function g(i, u) {
      ...
      r.extend(p, f.prototype), p._create = function() {
        ...
        var u = this._filterFindCellElements(i), y = u.map(function(x) {
          return new n(x, this);
        }, this);
        return y;
        ...
        if (this.slides = [], !!this.cells.length) {
          var i = new o(this);
          this.slides.push(i);
          var u = this.originSide == "left", y = u ? "marginRight" : "marginLeft", x = this._getCanCellFit();
        ...
        var y = typeof i == "string" && i.match(/^(\d+)%$/), x = y ? parseInt(y[1], 10) / 100 : 1;
        return function(b, E) {
      ...
      return p.setCellAlign = function() {
        ...
        if (!!this.options.wrapAround) {
          ...
          var i = this.cursorPosition, u = this.cells.length - 1;
        ...
        if (!(!this.options.contain || this.options.wrapAround || !this.cells.length)) {
          var i = this.options.rightToLeft, u = i ? "marginRight" : "marginLeft", y = i ? "marginLeft" : "marginRight", x = this.slideableWidth - this.getLastCell().size[y], b = x < this.size.innerWidth, E = this.cursorPosition + this.cells[0].size[u], C = x - this.size.innerWidth * (1 - this.cellAlign);
        ...
        var u = this.slides.length, y = this.options.wrapAround && u > 1;
        if (!y)
          return i;
        var x = r.modulo(i, u), b = Math.abs(x - this.selectedIndex), E = Math.abs(x + u - this.selectedIndex), C = Math.abs(x - u - this.selectedIndex);
        ...
        for (var u = 0; u < this.slides.length; u++) {
          var y = this.slides[u], x = y.cells.indexOf(i);
          if (x != -1)
            return u;
        }
        ...
        for (var x = [], b = u - i; b <= u + i; b++) {
          var E = this.options.wrapAround ? r.modulo(b, y) : b, C = this.slides[E];
        ...
        var i = h.pageYOffset;
        this.element.focus({ preventScroll: !0 }), h.pageYOffset != i && h.scrollTo(h.pageXOffset, i);
...
var U = { exports: {} }, w = { exports: {} }, R = { exports: {} };
var nt;
function G() {
  return nt || (nt = 1, function(m) {
    (function(a, h) {
      ...
      n.bindStartEvent = function(t) {
        ...
        e = e === void 0 ? !0 : e;
        var s = e ? "addEventListener" : "removeEventListener", c = "mousedown";
        ...
        for (var e = 0; e < t.length; e++) {
          var s = t[e];
          if (s.identifier == this.pointerIdentifier)
            return s;
        }
  ...
  return st || (st = 1, function(m) {
    (function(a, h) {
      ...
      return r.okayPointerDown = function(t) {
        var e = n[t.target.nodeName], s = o[t.target.type], c = !e || s;
  ...
  return rt || (rt = 1, function(m) {
    (function(a, h) {
      ...
      n.pointerDownFocus = function(e) {
        ...
        var s = e.type == "touchstart", c = e.pointerType == "touch", v = o[e.target.nodeName];
        ...
        var e = this.getRestingPosition(), s = Math.abs(this.getSlideDistance(-e, this.selectedIndex)), c = this._getClosestResting(e, s, 1), v = this._getClosestResting(e, s, -1), d = c.distance < v.distance ? c.index : v.index;
        return d;
        ...
        for (var v = this.selectedIndex, d = 1 / 0, S = this.options.contain && !this.options.wrapAround ? function(g, p) {
          ...
          return g < p;
        }; S(s, d) && (v += c, d = s, s = this.getSlideDistance(-e, v), s !== null); )
          s = Math.abs(s);
        return {
          distance: d,
          index: v - c
        ...
        var c = this.slides.length, v = this.options.wrapAround && c > 1, d = v ? r.modulo(s, c) : s, S = this.slides[d];
        if (!S)
          return null;
        ...
        if (this.previousDragX === void 0 || !this.dragMoveTime || new Date() - this.dragMoveTime > 100)
          return 0;
        var e = this.getSlideDistance(-this.dragX, this.selectedIndex), s = this.previousDragX - this.dragX;
        return e > 0 && s > 0 ? 1 : e < 0 && s < 0 ? -1 : 0;
      }, n.staticClick = function(e, s) {
        var c = this.getParentCell(e.target), v = c && c.element, d = c && this.cells.indexOf(c);
        this.dispatchEvent("staticClick", e, [s, v, d]);
      }, n.onscroll = function() {
        var e = t(), s = this.pointerDownScroll.x - e.x, c = this.pointerDownScroll.y - e.y;
  ...
  return ot || (ot = 1, function(m) {
    (function(a, h) {
      ...
      o.prototype = Object.create(l.prototype), o.prototype._create = function() {
        ...
        var c = document.createElementNS(n, "path"), v = t(this.parent.options.arrowShape);
      ...
      o.prototype.handleEvent = r.handleEvent, o.prototype.onclick = function() {
        ...
        var c = s.length ? s.length - 1 : 0, v = this.isPrevious ? 0 : c, d = this.parent.selectedIndex == v ? "disable" : "enable";
        this[d]();
  ...
  return ct || (ct = 1, function(m) {
    (function(a, h) {
      ...
      r._createLazyload = function() {
        ...
        if (!!t) {
          var e = typeof t == "number" ? t : 0, s = this.getAdjacentCellElements(e), c = [];
      ...
      function n(t) {
        if (t.nodeName == "IMG") {
          var e = t.getAttribute("data-flickity-lazyload"), s = t.getAttribute("data-flickity-lazyload-src"), c = t.getAttribute("data-flickity-lazyload-srcset");
          if (e || s || c)
            return [t];
        }
        var v = "img[data-flickity-lazyload], img[data-flickity-lazyload-src], img[data-flickity-lazyload-srcset]", d = t.querySelectorAll(v);
      ...
      return o.prototype.handleEvent = l.handleEvent, o.prototype.load = function() {
        ...
        var s = this.flickity.getParentCell(this.img), c = s && s.element;
...
const Dt = X.exports, zt = /* @__PURE__ */ dt({
  __proto__: null,
  default: Dt
}, [X.exports]);

//# sourceMappingURL=index-24f78f07.mjs.map
